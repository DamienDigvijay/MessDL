...
public class SaturdayLunch extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SatLunch");
    ...
    private void onLeftSwipe() {
        Intent a = new Intent(this, SaturdaySnacks.class);
        startActivity(a);
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2,
            ...
            try {
                ...
                if (diff > SWIPE_MIN_DISTANCE
                    ...
                    SaturdayLunch.this.onLeftSwipe();

                    // Right swipe
                } else if (-diff > SWIPE_MIN_DISTANCE
                        && Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                    SaturdayLunch.this.onRightSwipe();
                }
            } catch (Exception e) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_saturday_lunch, menu);
        return true;
    }
