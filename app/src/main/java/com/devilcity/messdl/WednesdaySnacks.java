...
public class WednesdaySnacks extends ActionBarActivity {
    private GestureDetector gestureDetector;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wednesday_snacks);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("WedSnacks");
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2,
            ...
            try {
                ...
                if (diff > SWIPE_MIN_DISTANCE
                    ...
                    WednesdaySnacks.this.onLeftSwipe();

                    // Right swipe
                } else if (-diff > SWIPE_MIN_DISTANCE
                        && Math.abs(velocityX) > SWIPE_THRESHOLD_VELOCITY) {
                    WednesdaySnacks.this.onRightSwipe();
                }
            } catch (Exception e) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_wednesday_snacks, menu);
        return true;
    }
